...
function AdminLogin ()
{
    ...
    // toast notification
    const notification = ( m, p ) => { toast.success( ' ' + m + " " + p, { theme: "dark", position: "top-center", autoClose: 5000, hideProgressBar: true, closeOnClick: false, pauseOnHover: true, draggable: true, progress: undefined, } ); }
    const notificationotp = ( m ) => { toast.success( ' ' + m, { theme: "dark", position: "top-center", autoClose: 5000, hideProgressBar: true, closeOnClick: false, pauseOnHover: true, draggable: true, progress: undefined, } ); }
    ...
    const handleSubmit = async ( e ) =>
    {
        ...
        try
        {
            ...
            const url = "http://localhost:8714/api/admin/otpsendinga";
    ...
    const handleSubmitotp = async ( e ) =>
    {
        ...
        try
        {
            ...
            const url = "http://localhost:8714/api/admin/otpverificationa";

            const { data: res } = await axios.post( url, { otp, mob } );
            const createdmessage1 = res.message;
            const notify = notificationotp( createdmessage1 );
            ...
            <div className="wrapper wrapper--w780">
                <div className="card card-3" style={ { marginTop: "-85px" } }>
                    ...
                    <div className="card-body">
                        <center><h2 className="title">Access Admin Bro-Cart Account</h2></center>
