...
const Productoffer = () =>
{
    ...
    const getProductData = async () =>
    {
        try
        {
            ...
            setLoading( true );
            const url = "http://localhost:8714/api/admin/productByofferstatus";
    ...
    const canceloffer = async ( id ) =>
    {
        try
        {
            if ( window.confirm( "Are you sure to cancel ?" ) )
            {
                ...
                const url = "http://localhost:8714/api/admin/productcancelofffer/" + id;
                    ...
                    <div className='col-lg-5 col-md-12 col-12' style={ { background: "navy", marginTop: "-560px", width: "92%", marginLeft: '152px' } }>
                        <div className="page-wrapper bg-gra-01  font-poppins" style={ { background: "WHITE" } }>
                            <div className="wrapper wrapper--w780" style={ { marginLeft: '0px' } }>
                                <Link to='/Productofferadding'><button className='btn btn-bg-dark' style={ { background: 'green', borderRadius: '6px', margin: '10px' } }> + ADD</button></Link>
                            </div>
                            <div>
                                <div className="userList" style={ { width: "78%", margin: "75px" } }>
                                    <DataGrid
