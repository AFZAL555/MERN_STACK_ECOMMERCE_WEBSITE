...
const ProductAdding = () =>
{
  ...
  const handleSubmitdata = async ( e ) =>
  {
    ...
    try
    {
      ...
      const url = "http://localhost:8714/api/admin/addproductdata";
              ...
              <div className="wrapper wrapper--w780">
                <div className="card card-3">
                  ...
                  <div className="card-body">
                    ...
                    <center><h2 className="title">Adding New Product</h2></center>
                    ...
                    <div className="p-t-10">
                      <center> <button className="btn btn--pill btn--green" type="submit" onClick={ handleSubmitdata }>Add Product</button></center>
                    </div>
                  </div>
                </div>
              </div>
